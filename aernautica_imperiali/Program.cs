...
namespace aernautica_imperiali {
    class Program {
        static void Main(string[] args) {
            ...
            GameEngine.GetInstance().Imperialis.Planes[0].Move(new Point(1,4,2));
            ...
            GameEngine.GetInstance().Imperialis.Planes[3].Move(new Point(6,2,2));
            GameEngine.GetInstance().Ork.Planes[3].Move(new Point(8,14,2));
            
            GameEngine.GetInstance().Imperialis.Planes[4].Move(new Point(9,1,3));
            GameEngine.GetInstance().Ork.Planes[4].Move(new Point(11,13,3));
            
            GameEngine.GetInstance().Imperialis.Planes[5].Move(new Point(13,2,1));
            GameEngine.GetInstance().Ork.Planes[5].Move(new Point(13,12,3));
